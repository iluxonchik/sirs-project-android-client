...
public class StrengthValidatorTest {
    ...
    @Test
    public void isInputSanitized_Default_AlphaOnly_returnsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String defaultInput = "ola";
        assertThat(sv.isInputSanitized(defaultInput, null), is(true));
    }
    @Test
    public void isInputSanitized_Default_EmptyString_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String defaultInput = "o*1lasd13sa";
        assertThat(sv.isInputSanitized(defaultInput, null), is(false));
    }
    @Test
    public void isInputSanitized_Default_SpecialSyms_returnsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String defaultInput = "o*1lasd13sa";
        assertThat(sv.isInputSanitized(defaultInput, null), is(false));
    }
    @Test
    public void isInputSanitized_Default_FirstCharNumber_returnsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String defaultInput = "1o3sa";
        assertThat(sv.isInputSanitized(defaultInput, null), is(false));
    }
    @Test
    public void isInputSanitized_Default_UpperCase_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
    ...
    @Test
    public void isInputSanitized_Pattern_NoPattern_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
    ...
    @Test
    public void isInputSanitized_Pattern_NoPattern_returnsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String patternReg = null;
    ...
    @Test
    public void isInputSanitized_Pattern_EmptyPattern_returnsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String patternReg = "";
        String defaultInput = "aaaa";
    ...
    @Test
    public void isInputSanitized_Pattern_EverySym_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String patternReg = ".*";
    ...
    @Test
    public void isInputSanitized_Pattern_EscapedDot_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String patternReg = "\\.+";
        String defaultInput = "..";
        assertThat(sv.isInputSanitized(defaultInput, patternReg), is(true));
    ...
    @Test
    public void Password_ValidatePassword_SmallPassword_RetunsFalse() throws Exception {
        StrengthValidator sv = new StrengthValidator();
    ...
    @Test
    public void Password_validatePassword_Medium0_returnsTrue() throws Exception {
        StrengthValidator sv = new StrengthValidator();
        String password = "123PassworD123";
